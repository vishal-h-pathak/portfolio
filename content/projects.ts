...
export const PROJECTS: Project[] = [
  ...
  },
  {
    num: "B-03",
    title: "Job Pipeline",
    oneLiner: "hunter + applicant agent system",
    status: "wip",
    statusLabel: "WIP · v0",
    paragraphs: [
      {
        text: "Two agents: a hunter that surfaces roles I’d care about (filters defense / generic gov / mission-less), and an applicant that drafts tailored cover letters per posting. The point is to learn agentic loops on something I’ll feel the cost of when they fail.",
      },
      {
        text: "Currently dogfooding v0. Hunter is live; applicant is gated behind manual review until the false-positive rate stops being embarrassing.",
        dim: true,
      },
    ],
    meta: [
