 ...
 *
 * The Pill primitive itself (mono, 10px, tracked, square, hairline) now
 * lives in the shared components/Pill.tsx (every console tab uses it);
 * this file keeps the job-specific semantic wrappers: StatusBadge (four
 * lifecycle tones), TierPill (1 / 1.5 / 2 / 3), LocationBadge,
 * ConfidenceBadge, DegreeGatePill. Per-status ad-hoc styling anywhere
 * else is a bug.
 */
