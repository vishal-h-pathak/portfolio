 ...
 *
 * Reads/writes:
 *   GET  /api/dashboard/watchers  → { active_watcher_id, heartbeats }
 *   POST /api/dashboard/watchers  { watcher_id }
 *
...
export default function WatcherPanel() {
  ...
  const setActive = useCallback(
    async (watcherId: string, stale: boolean) => {
      ...
      try {
        await requestJSON("POST", "/api/dashboard/watchers", {
